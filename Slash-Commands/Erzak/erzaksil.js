...
module.exports = {
    data: new Discord.SlashCommandBuilder()
        .setName("erzaksil")
        .setDescription("ID'si girilen haneye erzak siler!")
        ...
        .addStringOption(options => 
            options
            .setName("tur")
            .setDescription("Hangi tür erzak sileceğiniz seçin.")
            .setRequired(true)
            .addChoices(
        ...
        .addIntegerOption(z => z.setName("miktar").setDescription("Silinicek erzak miktarı.").setRequired(true))
        ,
    run: async (client, interaction) => {
        ...
        interaction.reply({content: `${hane.haneIsmi} adlı haneye ${miktar} ${tur} silindi.`})
    }
};